    ...
    <div class="login-box">
        ...
        <c:choose>
            <c:when test="${registerMode}">
                ...
                <p class="switch-link">已有账号？<a href="${pageContext.request.contextPath}/login">去登录</a></p>
            </c:when>
            <c:otherwise>
                <form action="${pageContext.request.contextPath}/login" method="post">
                    <div class="form-group">
                ...
                <p class="switch-link">没有账号？<a href="${pageContext.request.contextPath}/login?register=true">注册一个新账号</a></p>
            </c:otherwise>
        </c:choose>
    </div>
</div>
